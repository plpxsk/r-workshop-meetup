...
## histograms are univariate: one variable
...
p + geom_point()
p + geom_point(aes(colour = PhD))
p + geom_point(colour = "green")
p + geom_point(colour = PhD)
...
p + geom_boxplot(notch = TRUE, notchwidth = .5) + geom_jitter(colour="sienna1")
